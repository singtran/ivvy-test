...
// TODO: make this a generic to be used for create and edit
export default function Edit({auth, address}: {auth: any, address: AddressProps}) { // TODO - type auth
    const { data, setData, errors, patch, processing, recentlySuccessful } = useForm(address);
    const submit = (e) => {
        e.preventDefault();
        patch(route('address.update', {address: data}));
    };
                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                    <div className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                        <section className="max-w-xl">
                            <header>
                                <h2 className="text-lg font-medium text-gray-900">Update Address Information</h2>
                            </header>
